# Archived Phase Staging Doctrine — 2026-09-10

This file preserves the original Phase 6 → Phase 7 staging doctrine exactly as historical project evidence.

It is **not** the active staging rule. Use `docs/PHASE_STAGING_DOCTRINE.md` for current work.
